...
class _UserProfileState extends State<UserProfile> {
  ...
  void initState() {
    ...
    loadUserData(); //getting the user detauils that is stored shared prefs while loggined or register
...
//dialog for shoeing the info and edit info
