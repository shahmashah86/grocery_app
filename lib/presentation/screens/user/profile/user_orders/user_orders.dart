                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              IconButton(
                                  onPressed: () {
                                    context.read<OrdersBloc>().add(OrderbyId(orderId: orderlistofUser[index].id!));
                                    Navigator.push(context,
                                        MaterialPageRoute(builder: (context) {
                                      return UserOrderCancel(orderId:orderlistofUser[index].id!,);
                                    }));
                                  },
                          ...
                          Row(
                            children: [Text(orderlistofUser[index].dateTime),
                            //  Text('4:58pm')
                            ],
                          ),
                          Divider(),
                          Row(
                            spacing: 8,
                            children: [
                              Text('${orderlistofUser[index].totalItems.toString()}Items'),
                              Text(
                                '●',
                                style: TextStyle(
                                    color: Colors.amber, fontSize: 18),
                              ),
                              Text('₹${orderlistofUser[index].totalAmount}'),
                              Spacer(),
                        
                                  Text(orderlistofUser[index].acknowledged==true?"Acknowledged":'Acknowledge',
                                  style: TextStyle(color:orderlistofUser[index].acknowledged==true
                                  ?Colors.green.shade700:Colors.indigo),)
