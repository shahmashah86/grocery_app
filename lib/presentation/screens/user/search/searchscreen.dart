...
//                         .where(
//                             (product) => product.products.isAvailable == true)
//                         .toList();
//                     ProductGrid(
...
//                   List<ProductRegModel>? searchList =searchController.text.isEmpty?state.productList: state.searchList;
//                   return ProductGrid(
//                     productdetail: searchList,
//                     bySearch:searchController.text.isEmpty?false: !state.frombottomnav,
//                   );
//                 }
//               }
...
//               context
//                   .read<ProductBloc>()
//                   .add(Productsearch(productName: value));
