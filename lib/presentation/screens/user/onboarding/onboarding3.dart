...
class Onboarding3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body:Stack(children: [Container(height:double.infinity,width: double.infinity,color:Color.fromARGB(255, 244, 227, 201),
    ),ClipPath(clipper: CustomClipperClass3(),
      child: Container(height: MediaQuery.of(context).size.height*0.52,width: double.infinity,color: Colors.orange,
      child: Image.asset('assets/images/face.jpeg',fit: BoxFit.cover,),
      ),
