                      ...
                      if (state is ProductLoaded) {
                        if (state.message.isNotEmpty) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(backgroundColor: Colors.lime,
                              content: Text(
                                state.message,style: TextStyle(color: Colors.black87),
                              ),
                              duration: Duration(seconds: 2),
                            ),
                          );
                        }
                        if (state.isError &&state.mode==ProdCreateEditScreen.add) {
                          log("inside error state");

                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(backgroundColor: Colors.red,
                              content: Text(
                                state.errormsg??'something wrong while registering',
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            ...
                            content: Text(state.msg ??
                                'Something wrong while registering',style: TextStyle(color: Colors.white),),
                            duration: Duration(seconds: 2),
                          ),
                        );
                      }
