              ...
              builder: (context, state) {
                ...
                Column(
                  children: [Padding(
                    ...
                    child: InkWell(child: Row(mainAxisAlignment: MainAxisAlignment.end,
                      children: [
                        Text("trending now",style: TextStyle(fontSize: 20),),Icon(Icons.arrow_forward)
                      ],
                    ),
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context){
                                                               final List<ProductsModel> trendingProducts=state.dashboardData!.trendingProducts;
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          state.dashboardData!.stockOutProductCount??"",
