  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(children: [
        ...
        Center(
            child: ValueListenableBuilder(valueListenable: isBannerVisible,
            builder: (context, value, child) => 
               AbsorbPointer(absorbing: value,
                 child: SizedBox(
                    height: 300,
                    width: 300,
                    child: Form(
                              ...
                              if (state is AuthError) {
                                ...
                                if (message.contains(
                                  ...
                                  message = "username is already used try another";
                                    ...
                                    .contains('Connnection error:Please check your internet connection')) {
       ...
       ValueListenableBuilder(valueListenable: isBannerVisible,
         builder: (context,value,child) {
           return value?  Container(color: Colors.black.withOpacity(0.3),):SizedBox.shrink();
         }
       )
